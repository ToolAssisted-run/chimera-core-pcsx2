...
#define ACUART_LOG(fmt, ...) if (chimera_arcade_verbose) Console.WriteLn(Color_Gray, "ACUART:" fmt __VA_OPT__(,) __VA_ARGS__)
#define ACUART_WARN(fmt, ...) if (chimera_arcade_verbose) Console.Warning("ACUART:" fmt __VA_OPT__(,) __VA_ARGS__)
